...
def main(): #<-- Don't change this line!
    ...
    overTime = ((hoursWorked - overtimeBracket) * (hourlyRate * 1.5)) + (overtimeBracket * hourlyRate)      #Clac for overtime.

    if hoursWorked > overtimeBracket:                                                                       #Conditional statement for overtimeBracket.
